    ...
    <section id="main" class="main">
        <div class="main_left">
            ...
            <p>Ние сме малка компания, специализирана в изработката на <strong>custom уеб-сайтове</strong>,
                ...
                Работим също по проекти, свързани с онлайн търговия и SEO на съществуващи сайтове.
            </p>
        </div>
        ...
        <div class="main_left">
            ...
            <p class="projects">
                <a target="_blank" rel="nofollow" href="https://www.sefobg.com"
                    title="Сейфетин Шекеров Сефо - скулптор">Сефо<i
                        class="fa-solid fa-arrow-up-right-from-square"></i></a>
                <a target="_blank" rel="nofollow" href="https://www.han.jeravna.com"
                    title="Къща за гости хаджи Вълчевия хан - Жеравна">х. Вълчевия хан<i
                        class="fa-solid fa-arrow-up-right-from-square"></i></a>
                <a target="_blank" rel="nofollow" href="https://www.gmmetaldetectors.com"
                    title="Golden Mask корпоративен уеб сайт">Golden Mask<i
                        class="fa-solid fa-arrow-up-right-from-square"></i></a>
                <a target="_blank" href="https://www.goldenmaskdetectors.com"
                    title="Онлайн магазин на Golden Mask metal detectors">GMD<i
                        class="fa-solid fa-arrow-up-right-from-square"></i></a>
                <a target="_blank" rel="nofollow" href="https://www.svetinikola.jeravna.com"
                    title="Къща за гости Св. Никола - Жеравна">Св. Никола<i
                        class="fa-solid fa-arrow-up-right-from-square"></i></a>
                <a target="_blank" rel="nofollow" href="https://www.jeravna.com"
                    title="Официален портал на село Жеравна">Жеравна<i
                        class="fa-solid fa-arrow-up-right-from-square"></i></a>
            </p>
